...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      posts: [],
      api_token: 'PekImyqsD5QkPhkFeTBLeTAtwELvGZsTxo68S8cMw3F2gWjfkppET4D3ULmMiAEHjLtuKwNBDdsBhoMx'
    };
  },
  created: function created() {
    this.getPost();
  ...
  methods: {
    getPost: function getPost() {
      ...
      var config = {
        headers: {
          Autorization: "Bearer ".concat(this.api_token)
        }
      };
      axios.post(this.url, bosyParameters, config).then(function (response) {
...
//
//
// si puo' decidere se togliere la destionazione o tenerla (io la tolgo che mi da degli erroiri) 
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("header", [_c("h1", [_vm._v("sono header")])])
  },
]
...
module.exports = __webpack_require__(/*! C:\Users\sonni\Desktop\lezioni\Laravel\Lezione6\laravel-boolpress\resources\js\front.js */"./resources/js/front.js");
